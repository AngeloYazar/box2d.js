...
ifeq ($(BUILD), debug)
	OPTS = -O0 -g2
	LINK_OPTS = -g4 --llvm-lto 0 -s NO_FILESYSTEM=1 -s ASSERTIONS=2 --closure 0 --pre-js "pre.js" -s DEMANGLE_SUPPORT=1 
else
	OPTS = -Os
	LINK_OPTS = -O3 --llvm-lto 1 -s NO_FILESYSTEM=1 --closure 1 --pre-js "pre.js" --js-transform "python bundle.py"
endif
